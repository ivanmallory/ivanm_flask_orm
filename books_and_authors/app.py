...
def book(id):
    ...
    return render_template("book_details.html", book=book, authors=potential_authors)

@app.route("/author_details/<id>")
def author(id):
    author = Author.query.get(id)
    potential_books = Book.query.all()
    return render_template("author_details.html", author=author, books=potential_books)
